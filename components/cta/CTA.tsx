...
const CTA = () => {
  return (
    ...
    <div
        className="overflow-hidden bg-white lg:mx-auto lg:flex lg:container lg:w-full lg:shadow-md lg:rounded-xl">
        <div className="lg:w-1/2">
            <Image src={HeroImage} alt='hero' className="h-64 bg-cover lg:h-full" />
        </div>
